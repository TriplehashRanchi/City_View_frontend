...
export default function NewQuotationFlow() {
  ...
  return (
    <div className="mx-auto max-w-[1500px] space-y-8">
      <PageIntro eyebrow="Quotations" title="New Quotation" description="Step through client, event, items, and pricing. The item workspace gets the most room because it is the main operator task." />
