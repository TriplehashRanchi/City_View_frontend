...
export default function TopNavbar({ onMenuClick = () => {}, onOpenSearch = () => {} }) {
  ...
  return (
    <header className="sticky top-0 z-30 border-b border-green-100 bg-white backdrop-blur-xl">
      <div className="flex h-20 items-center justify-between px-4 md:px-8">
        ...
        <div className="flex items-center gap-2 md:gap-4">
          ...
          <div className="hidden items-center gap-4 border-r border-green-500 pr-4 lg:flex">
